 ...
 */
@WebServlet("/finddeathdata")
public class FindDeathData extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (stateName == null || stateName.trim().isEmpty()) {
        	...
        	try {
        		deathdatas = deathdataDao.getDeathDatabyState(stateName);
            } catch (SQLException e) {
    			e.printStackTrace();
    			throw new IOException(e);
            }
        	messages.put("success", "Displaying results for " + stateName);
        	messages.put("DeathData", stateName);
        }
        req.setAttribute("deathdatas", deathdatas);
        
        req.getRequestDispatcher("/FindDeathData.jsp").forward(req, resp);
	}
